...
#        define ZEXPORT __export __far __loadds
#        define ZEXPORTVA __export __far __loadds
#      else
#        ifdef ZLIB_INTERNAL
...
#  define charf  char ZFAR
#  define intf   int ZFAR
#  define uIntf  uInt ZFAR
#  define uLongf uLong ZFAR
#else
   typedef Byte  Bytef;
   typedef char  charf;
   typedef int   intf;
